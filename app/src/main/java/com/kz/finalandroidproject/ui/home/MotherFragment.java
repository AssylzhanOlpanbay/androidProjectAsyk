...
import com.kz.finalandroidproject.Test.MotherTestActivity;
...
public class MotherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_mother_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mother, container, false);
        ...
        btn_mother_startTest = view.findViewById(R.id.btn_mother_startTest);
        ...
        btn_mother_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), MotherTestActivity.class);
