...
import com.kz.finalandroidproject.Test.BrotherTestActivity;
import com.kz.finalandroidproject.R;

import de.hdodenhof.circleimageview.CircleImageView;

public class BrotherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_brother_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_brother, container, false);
        ...
        btn_brother_startTest = view.findViewById(R.id.btn_brother_startTest);
        ...
        btn_brother_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), BrotherTestActivity.class);
