...
import com.kz.finalandroidproject.Test.FatherTestActivity;
...
public class FatherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_father_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_father, container, false);
        ...
        btn_father_startTest = view.findViewById(R.id.btn_father_startTest);
        ...
        btn_father_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), FatherTestActivity.class);
