...
import com.kz.finalandroidproject.Test.LittleBrotherTestActivity;
import com.kz.finalandroidproject.R;

import de.hdodenhof.circleimageview.CircleImageView;

public class LittleBrotherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_littleBrother_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_little_brother, container, false);
        ...
        btn_littleBrother_startTest = view.findViewById(R.id.btn_littleBrother_startTest);
        ...
        btn_littleBrother_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), LittleBrotherTestActivity.class);
