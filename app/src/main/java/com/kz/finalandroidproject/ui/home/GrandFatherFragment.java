...
import com.kz.finalandroidproject.Test.TestActivity;

import de.hdodenhof.circleimageview.CircleImageView;

public class GrandFatherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_grandfather_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_grand_father, container, false);
        ...
        btn_grandfather_startTest = view.findViewById(R.id.btn_grandfather_startTest);
        ...
        btn_grandfather_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
