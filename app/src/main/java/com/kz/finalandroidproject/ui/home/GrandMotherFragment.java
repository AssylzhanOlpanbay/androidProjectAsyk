...
import com.kz.finalandroidproject.Test.GrandMotherTetsActivity;
import com.kz.finalandroidproject.R;

import de.hdodenhof.circleimageview.CircleImageView;

public class GrandMotherFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_grandmother_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_grand_mother, container, false);
        ...
        btn_grandmother_startTest = view.findViewById(R.id.btn_grandmother_startTest);
        ...
        btn_grandmother_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), GrandMotherTetsActivity.class);
