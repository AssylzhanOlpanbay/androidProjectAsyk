...
import com.kz.finalandroidproject.Test.LittleSisterActivity;
...
public class LittleSisterFragment extends Fragment {
    ...
    Button btn_call, btn_sms, btn_littleSister_startTest;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_little_sister, container, false);
        ...
        btn_littleSister_startTest = view.findViewById(R.id.btn_littleSister_startTest);
        ...
        btn_littleSister_startTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(getActivity(), LittleSisterActivity.class);
