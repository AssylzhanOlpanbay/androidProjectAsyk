...
public class TestActivity extends AppCompatActivity {
    ...
    String [] questions = {"What year was your grandfather born?", "Grandpa's name?", "Grandpa's email?", "Grandpa's birthday?", "Grandpa's hobby?",
            "Grandpa's instagram?", "Grandpa's telegram?", "Grandpa's twitter", "How old is grandpa?", "What month was grandpa born?"};

    double questionCount = questions.length;
    double counter = 0;
    String [][] variants = {
            {"1950" , "1955"},
            {"Kevin Smith" , "Will Smith"},
            {"will@gmail.com" , "will50@gmail.com"},
            {"29.05.1950" , "29.06.1950"},
    ...
    String [] answers = {"1950", "Will Smith", "will50@gmail.com", "29.05.1950", "Football", "will.smith", "will_smith", "Will Smith", "73", "05"};
