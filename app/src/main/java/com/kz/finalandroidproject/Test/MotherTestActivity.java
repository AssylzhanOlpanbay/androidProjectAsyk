...
public class MotherTestActivity extends AppCompatActivity {
    ...
    String [] questions = {"What year was your mother born?", "Mother's name?", "Mother's email?", "Mother's birthday?", "Mother's hobby?",
            "Mother's instagram?", "Mother's telegram?", "Mother's twitter", "How old is mother?", "What month was mother born?"};

    double questionCount = questions.length;
    double counter = 0;
    String [][] variants = {
            {"1957" , "1977"},
            {"Alise Tailor" , "Will Smith"},
            {"alise1977@gmail.com" , "alise77@gmail.com"},
            {"07.01.1977" , "29.06.1950"},
            {"Football" , "watch a serials"},
            {"alisetailor1977" , "alise1977"},
            {"alise.tailor77" , "alisetailor1977"},
            {"AliseTailor" , "Alise Tailor"},
            {"46" , "68"},
            {"01" , "06"},
    };

    String [] answers = {"1977", "Alise Tailor", "alise1977@gmail.com", "07.01.1977", "watch a serials", "alisetailor1977", "alise.tailor77", "Alise Tailor", "46", "01"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_test);
