...
public class BrotherTestActivity extends AppCompatActivity {
    ...
    String [] questions = {"What year was your brother born?", "Brother's name?", "Brother's email?", "Brother's birthday?", "Brother's hobby?",
            "Brother's instagram?", "Brother's telegram?", "Brother's twitter", "How old is brother?", "What month was brother born?"};

    double questionCount = questions.length;
    double counter = 0;
    String [][] variants = {
            {"2000" , "2002"},
            {"Kevin Cruz" , "Kevin Smith"},
            {"kevinc@gmail.com" , "kcruz@gmail.com"},
            {"09.11.2000" , "29.06.2002"},
            {"Football" , "watch a TV program"},
            {"kevin.c" , "kevincruz"},
            {"@kevin_cruz" , "@kevin.cruz"},
            {"KevinCruz" , "Kevin Cruz"},
            {"23" , "21"},
            {"11" , "06"},
    };

    String [] answers = {"2000", "Kevin Cruz", "kevinc@gmail.com", "09.11.2000", "Football", "kevin.c", "@kevin_cruz", "Kevin Cruz", "23", "11"};

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brother_test);
