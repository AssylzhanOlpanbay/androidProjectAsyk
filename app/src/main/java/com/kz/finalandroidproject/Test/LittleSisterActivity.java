...
public class LittleSisterActivity extends AppCompatActivity {
    ...
    String [] questions = {"What year was your little sister born?", "Little sister's name?", "Little sister's email?", "Little sister's birthday?", "Little sister's hobby?",
            "Little sister's instagram?", "Little sister's telegram?", "Little sister's twitter", "How old is little sister?", "What month was little sister born?"};

    double questionCount = questions.length;
    double counter = 0;
    String [][] variants = {
            {"2012" , "2011"},
            {"Marines Cruz" , "Will Smith"},
            {"mcruz@gmail.com" , "marinesc@gmail.com"},
            {"29.05.2012" , "14.11.2012"},
            {"Watch a films" , "watch a TV program"},
            {"m.cruz" , "marines2012"},
            {"@m.cruz" , "@mcruz"},
            {"Marines Cruz" , "Marines C"},
            {"12" , "10"},
            {"05" , "11"}
    };

    String [] answers = {"2012", "Marines Cruz", "mcruz@gmail.com", "14.11.2012", "Watch a films", "m.cruz", "@m.cruz", "Marines Cruz", "10", "11"};
