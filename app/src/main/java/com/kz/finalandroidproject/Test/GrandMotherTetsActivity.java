...
public class GrandMotherTetsActivity extends AppCompatActivity {
    ...
    String [] questions = {"What year was your grandmother born?", "Grandma's name?", "Grandma's email?", "Grandma's birthday?", "Grandma's hobby?",
            "Grandma's instagram?", "Grandma's telegram?", "Grandma's twitter", "How old is grandma?", "What month was grandma born?"};

    double questionCount = questions.length;
    double counter = 0;
    String [][] variants = {
            {"1965" , "1955"},
            {"Lisa Carol" , "Lisa Smith"},
            {"lisa@gmail.com" , "lisa55@gmail.com"},
            {"30.11.1955" , "29.06.1950"},
            {"Basketball" , "Cooking"},
            {"lisa.c" , "lisac"},
            {"@lisacarol" , "@lisalisa"},
            {"Carol Lisa" , "Lisa Carol"},
            {"68" , "70"},
            {"11" , "07"},
    };

    String [] answers = {"1955", "Lisa Carol", "lisa55@gmail.com", "30.11.1955", "Cooking", "lisa.c", "@lisalisa", "Lisa Carol", "68", "11"};

    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grand_mother_tets);
